...
console.log(greeting('Tom', 'Smith'))

// Write a function named oddOrEven that takes a number as an argument and returns whether the number is odd or even.
// pass in a number
// we want to know if the number is can be divided by 2 without a remainder
// check if that number is even, if it is --- return EVEN, else ---- returns ODD
...
const divisibleBy = (num1, num2) => {
    if (num1 % num2 === 0){
        return `${num1} is evenly disible by ${num2}`
    } else {
