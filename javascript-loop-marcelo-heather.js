...
// Fizz Buzz: Use a for loop to log all numbers from 1-100. If a number is a multiple of 3, 
// replace it with the word fizz. If a number is a multiple of five, replace it with the word buzz. 
