...
// 1. Even or Odd: Write a for loop that iterates from 0 to 15. 
//For each iteration, it will check if the current number is odd or even, and display the appropriate outcome. 
...
// 2. Fizz Buzz: Use a for loop to log all numbers from 1-100.  
